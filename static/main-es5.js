...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<app-consult-view></app-consult-view>";
    /***/
  },
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppConsultViewConsultViewComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppHelpersTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "Sexe", function () {
      return Sexe;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "Niveau", function () {
      return Niveau;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "Jeun", function () {
      return Jeun;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "Electrocardio", function () {
      return Electrocardio;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "Angine", function () {
      return Angine;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "Pente", function () {
      return Pente;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "Fluoroscopie", function () {
      return Fluoroscopie;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "Thalassemie", function () {
      return Thalassemie;
    });
    /* harmony export (binding) */
    ...
    __webpack_require__.d(__webpack_exports__, "Consultation", function () {
      return Consultation;
    });
    /* harmony export (binding) */
    ...
    /*! @angular/core */
    "./node_modules/@angular/core/fesm2015/core.js"); //import { Consultation } from './model/consultation'


    var Sexe = function Sexe(name, Id) {
      _classCallCheck(this, Sexe);

      this.name = name;
      this.Id = Id;
    };

    var Niveau = function Niveau(name, Id) {
      _classCallCheck(this, Niveau);

      this.name = name;
      this.Id = Id;
    };

    var Jeun = function Jeun(name, Id) {
      _classCallCheck(this, Jeun);

      this.name = name;
      this.Id = Id;
    };

    var Electrocardio = function Electrocardio(name, Id) {
      _classCallCheck(this, Electrocardio);

      this.name = name;
      this.Id = Id;
    };

    var Angine = function Angine(name, Id) {
      _classCallCheck(this, Angine);

      this.name = name;
      this.Id = Id;
    };

    var Pente = function Pente(name, Id) {
      _classCallCheck(this, Pente);

      this.name = name;
      this.Id = Id;
    };

    var Fluoroscopie = function Fluoroscopie(Id) {
      _classCallCheck(this, Fluoroscopie);

      this.Id = Id;
    };

    var Thalassemie = function Thalassemie(name, Id) {
      _classCallCheck(this, Thalassemie);

      this.name = name;
      this.Id = Id;
    };

    var Langue = function Langue(name, Id) {
    ...
    function () {
      ...
      _createClass(ConsultationService, [{
        key: "getNiveauFr",
        value: function getNiveauFr() {
          var niveaux = [new Niveau('Angine de poitrine typique', 0), new Niveau('Angine de poitrine atypique', 1), new Niveau('Douleur pas due à l\'angine', 2), new Niveau('Asymptomatique', 3)];
          return niveaux;
        }
      }, {
        key: "getNiveau",
        value: function getNiveau() {
          var niveaux = [new Niveau('Typical angina', 0), new Niveau('Atypical angina', 1), new Niveau('Non-angina pain', 2), new Niveau('Asymptomatic', 3)];
          return niveaux;
        }
      }, {
        key: "getjeun",
        value: function getjeun() {
          var jeuns = [new Jeun('yes', 1), new Jeun('no', 0)];
          return jeuns;
        }
      }, {
        key: "getjeunFr",
        value: function getjeunFr() {
          var jeuns = [new Jeun('oui', 1), new Jeun('non', 0)];
          return jeuns;
        }
      }, {
        key: "getElectrocardioFr",
        value: function getElectrocardioFr() {
          var electrocardios = [new Electrocardio('Normal', 0), new Electrocardio('Ayant ST-T', 1), new Electrocardio('Hypertrophie', 2)];
          return electrocardios;
        }
      }, {
        key: "getElectrocardio",
        value: function getElectrocardio() {
          var electrocardios = [new Electrocardio('Normal', 0), new Electrocardio('Having ST-T', 1), new Electrocardio('Hypertrophy', 2)];
          return electrocardios;
        }
      }, {
        key: "getAngineFr",
        value: function getAngineFr() {
          var angines = [new Angine('oui', 1), new Angine('non', 0)];
          return angines;
        }
      }, {
        key: "getAngine",
        value: function getAngine() {
          var angines = [new Angine('yes', 1), new Angine('no', 0)];
          return angines;
        }
      }, {
        key: "getPenteFr",
        value: function getPenteFr() {
          var pentes = [new Pente('Montée', 0), new Pente('Plate', 1), new Pente('Descente', 2)];
          return pentes;
        }
      }, {
        key: "getPente",
        value: function getPente() {
          var pentes = [new Pente('Upsloping', 0), new Pente('Flat', 1), new Pente('Downsloping', 2)];
          return pentes;
        }
      }, {
        key: "getFluoroscopie",
        value: function getFluoroscopie() {
          var fluoroscopies = [new Fluoroscopie(0), new Fluoroscopie(1), new Fluoroscopie(2), new Fluoroscopie(3)];
          return fluoroscopies;
        }
      }, {
        key: "getThalassemie",
        value: function getThalassemie() {
          var thalassemies = [new Thalassemie('Normal', 1), new Thalassemie('Fixed defect', 2), new Thalassemie('Reversable defect', 3)];
          return thalassemies;
        }
      }, {
        key: "getThalassemieFr",
        value: function getThalassemieFr() {
          var thalassemies = [new Thalassemie('Normal', 1), new Thalassemie('Defaut corrigé', 2), new Thalassemie('Defaut reversible', 3)];
          return thalassemies;
        }
      }, {
        key: "getSexeFr",
        value: function getSexeFr() {
          var sexes = [new Sexe('Homme', 1), new Sexe('Femme', 0)];
          return sexes;
        }
      }, {
        key: "getSexe",
        value: function getSexe() {
          var sexes = [new Sexe('Male', 1), new Sexe('Female', 0)];
          return sexes;
        }
      }, {
        key: "getLangue",
        value: function getLangue() {
          var langues = [new Langue("EN", 1), new Langue("FR", 2)];
          return langues;
        }
      }, {
        key: "createConsultation",
        value: function createConsultation(consultation) {
    ...
    ConsultationService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], ConsultationService);
    /***/
  },
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! @ngx-translate/core */
    "./node_modules/@ngx-translate/core/@ngx-translate/core.js");
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _consult_view_consult_view_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./consult-view/consult-view.component */
    ...
    var _resultat_resultat_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    ...
    var routes = [{
      path: 'decision',
      component: _consult_view_consult_view_component__WEBPACK_IMPORTED_MODULE_7__["ConsultViewComponent"]
    }, {
      path: '',
      component: _consult_view_consult_view_component__WEBPACK_IMPORTED_MODULE_7__["ConsultViewComponent"]
    }];
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _consult_view_consult_view_component__WEBPACK_IMPORTED_MODULE_7__["ConsultViewComponent"], _resultat_resultat_component__WEBPACK_IMPORTED_MODULE_10__["ResultatComponent"]],
      imports: [angular_bootstrap_md__WEBPACK_IMPORTED_MODULE_8__["MDBBootstrapModule"].forRoot(), _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forRoot(routes), _angular_material_button__WEBPACK_IMPORTED_MODULE_11__["MatButtonModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_12__["MatDialogModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_13__["BrowserAnimationsModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_14__["TranslateModule"].forRoot({
        loader: {
  ...
  /***/
  function srcAppConsultViewConsultViewComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppConsultViewConsultViewComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ConsultViewComponent", function () {
      return ConsultViewComponent;
    });
    /* harmony import */
    ...
    var _model_consult_consult__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var _rest_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../rest.service */
    "./src/app/rest.service.ts");

    var ConsultViewComponent =
    /*#__PURE__*/
    function () {
      function ConsultViewComponent(matDialog, consultationService, router, http, translate, rs) {
        _classCallCheck(this, ConsultViewComponent);
        ...
        this.consultation = new _Helpers__WEBPACK_IMPORTED_MODULE_2__["Consultation"](); //*****variables pour manipuler le serveur

        this.url = "decision";
        translate.setDefaultLang('EN');
      }

      _createClass(ConsultViewComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          ...
          this.thalassemies = this.consultationService.getThalassemie(); //valeur par defaaut des select boxes
        ...
        key: "onSubmit",
        value: function onSubmit(consultForm) {
          var _this = this;
          ...
          var age = consultForm.controls['age'].value;
          var sexe = consultForm.controls['sexe'].value;
          var niveau = consultForm.controls['niveau'].value;
          var pression = consultForm.controls['pression'].value;
          var cholesterol = consultForm.controls['age'].value;
          var jeun = consultForm.controls['jeun'].value;
          var electrocardio = consultForm.controls['electrocardio'].value;
          var frequence = consultForm.controls['frequence'].value;
          var angine = consultForm.controls['angine'].value;
          var decalage = consultForm.controls['decalage'].value;
          var pente = consultForm.controls['pente'].value;
          var fluoroscopie = consultForm.controls['fluoroscopie'].value;
          var thalassemie = consultForm.controls['thalassemie'].value;
          ...
          var newConsultation = new _model_consult_consult__WEBPACK_IMPORTED_MODULE_6__["Consult"]();
          newConsultation.age = age;
          ...
          newConsultation.thalassemie = thalassemie.Id; //savegarde de informations
          ...
          var quete = {
            ...
            "glycemie": jeun.Id,
            "electrocardio": electrocardio.Id,
            "frequence": frequence,
            "angine": angine.Id,
            "decalage": decalage,
            "pente": pente.Id,
            "fluoroscopie": fluoroscopie.Id,
            "thalassemie": thalassemie.Id
          };
          console.log(quete); //envoyer la recherche au serveur

          this.http.post("http://127.0.0.1:5002/decision", quete).subscribe(function (data) {
            _this.resultat = data['resultat'];
            /*console.log(this.resultat);
            alert("The probability that the patient is sick is " + this.resultat);
            */

            _this.afficherResultat();
          });
        }
      }, {
        key: "afficherResultat",
        value: function afficherResultat() {
          var dialogConfig = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialogConfig"](); // The user can't close the dialog by clicking outside its body

          dialogConfig.disableClose = true;
          dialogConfig.id = "resultat-component";
          dialogConfig.height = "270px";
          dialogConfig.width = "400px";
          dialogConfig.data = this.resultat.toFixed(2); // https://material.angular.io/components/dialog/overview

          var modalDialog = this.matDialog.open(_resultat_resultat_component__WEBPACK_IMPORTED_MODULE_4__["ResultatComponent"], dialogConfig);
        }
      }, {
        key: "onReset",
        value: function onReset(consultForm) {
    ...
    ConsultViewComponent.ctorParameters = function () {
      return [{
    ...
    ConsultViewComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-consult-view',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./consult-view.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/consult-view/consult-view.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./consult-view.component.scss */
      "./src/app/consult-view/consult-view.component.scss")).default]
  ...
  /***/
  function srcAppModelConsultConsultTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "Consult", function () {
      return Consult;
    });
    /* harmony import */
    ...
    var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! tslib */
    "./node_modules/tslib/tslib.es6.js"); //import { Sexe, Niveau, Glycemie, Electrocardio, Angine, Pente, Fluoroscopie, thalassemie } from '';
  ...
  function srcAppResultatResultatComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function ResultatComponent(dialogRef, data) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"]))], ResultatComponent);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\Info\MLPC\app de maladie cardiaque\my-app\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
